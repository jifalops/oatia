<?php
	...
	// These are shortened file paths usable as HTTP paths (i.e. "/oatia/filename.ext")
	define('BASE_DIR_SHORT', 	dirname($_SERVER['PHP_SELF']));
    define('LIBRARY_DIR_SHORT', 	BASE_DIR_SHORT.DS.'libs');
	define('TEST_DIR_SHORT', 	LIBRARY_DIR_SHORT.DS.'tests');
	define('PRIVATE_DIR_SHORT', 	BASE_DIR.DS_SHORT.'.private');
	...
	*/
	...
	$db = new MySqlConnection($PRIVATE['DB_SERVER'], 	$PRIVATE['DB_USERNAME'], 
	...
	function show_navigation() {
		echo '<a href="/oatia/index.php">Home</a>
			| <a href="/oatia/documents/">Documents</a>
			| <a href="/oatia/geo/">Geocoding</a><br /><br />
			
			Example App Lists (needs updated) <br />

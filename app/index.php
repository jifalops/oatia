<?php
	...
	echo '<p><a href="https://github.com/jphilli85/robodex/tags">Version Descriptions</a></p>'.NL;

	$files = gather_files('.', 'apk');
	...
	function gather_files($dir, $ext) {
        // File system objects
        $fsos = scandir($dir);
        foreach ($fsos as $fso) {
            $fso_full = $dir . DS . $fso;                
            if (is_file($fso_full) && substr($fso, -4, 4) == '.'.$ext) {
